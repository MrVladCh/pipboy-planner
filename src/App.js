              ...
              <div className="ml-4 text-sm">
                ...
                <ul>
                  {quest.subtasks.length === 0 && !quest.showSubtaskInput && (
                    <li>
                      <button
                        onClick={() => updateQuest(quest.id, { showSubtaskInput: true })}
                        style={{
                          width: "28px",
                          height: "28px",
                          borderRadius: "4px",
                  ...
                  {quest.subtasks.map((s, i) => (
                    <li
                      ...
                      onDoubleClick={() => updateQuest(quest.id, { editingSubtask: i })}
                      className={`cursor-pointer ${s.done ? "faded" : ""}`}
                    >
                      {quest.editingSubtask === i ? (
                        <input
                          type="text"
                          defaultValue={s.text}
                          autoFocus
                          onBlur={(e) => {
                            ...
                            if (text) {
                              ...
                              newSubtasks[i].text = text;
                              updateQuest(quest.id, { subtasks: newSubtasks, editingSubtask: null });
                            } else {
                              updateQuest(quest.id, { editingSubtask: null });
                            }
                          }}
                          onKeyDown={(e) => {
